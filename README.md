...
All figures and result tables are deliberate placeholders. No synthetic results are included. The manuscript documents a cross-environment evaluation spanning Mini-IPTE, ProcTHOR task compositions, HM3D/HM3D-OVON, OpenEQA active exploration, HSSD ObjectNav, Habitat-GS PointNav, dynamic HSSD/P4D-Bench, and physical deployment on DEEP Robotics LYNX M20, X30, and Lite3 platforms in indoor and outdoor environments. Quantitative simulation and robot results and qualitative frames remain placeholders. Keep iclrfinalcopy commented for anonymous review and enable it only for the camera-ready version.
