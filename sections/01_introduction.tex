...
\begin{enumerate}[leftmargin=*,itemsep=2pt,topsep=3pt]
  ...
  We define \bench{} across controlled and photorealistic environments and demonstrate physical deployment on three robots, testing endpoint-proxy mismatch, timing sensitivity, compositional generalization, and robustness to arrival and task-prior shift.
\end{enumerate}
