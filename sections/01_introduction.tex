...
\begin{figure}[t]
  \centering
  \placeholderfigure{4.2cm}{Introduction overview: fixed-budget exploration versus \taskname{}; a request interrupts a macro-action; \method{} prioritizes evidence that becomes useful early.}
...
A photorealistic layer uses HM3D in Habitat
\citep{savva2019habitat,ramakrishnan2021hm3d}
with RGB-D, noisy odometry, and frozen perception, navigation, memory capacity, and downstream executors shared by all methods.
...
The evaluation spans early-heavy, memoryless, late-heavy, burst, and misspecified arrival processes.
...
\begin{enumerate}[leftmargin=*,itemsep=2pt,topsep=3pt]
  ...
  We define \bench{} across controlled and photorealistic environments to test endpoint-proxy mismatch, timing sensitivity, compositional generalization, and robustness to arrival and task-prior shift.
\end{enumerate}
