...
\begin{figure*}[t]
  \centering
  \placeholderfigure{4.3cm}{Benchmark overview: Mini-\taskname{} mechanism layer; HM3D/Habitat photorealistic layer; indoor/outdoor physical deployment on M20, X30, and Lite3; four task families; five arrival processes; atomic interruption protocol.}
  \caption{\textbf{\bench{} design.}
  The controlled layer supplies exact oracles and diagnostic counterexamples.
  Simulation and physical deployments evaluate the same interruption semantics with noisy embodied perception and navigation.}
  \label{fig:benchmark}
\end{figure*}
